    ...
    <nav className="flex flex-col h-screen">
      ...
      {openham && (
        <div className=" z-10 flex flex-col  bg-slate-700 text-white  items-center gap-9">
          <Link
            href="/"
            className="p-3 mt-5 cursor-pointer"
            onClick={() => setOpenham(!openham)}
          >
            Dashboard
          </Link>
      ...
      <div className="max-md:hidden  flex w-52 flex-col flex-grow bg-slate-700 text-white  items-center gap-9">
        <Link href="/" className="p-3 mt-5 cursor-pointer">
          Dashboard
        </Link>
        <Link href="/Incident" className="p-3 mt-5 cursor-pointer">
          Incidents
        </Link>
        <Link href="/Chat" className="p-3 mt-5 cursor-pointer">
          Chat
        </Link>
        <Link href="/Report" className="p-3 mt-5 cursor-pointer">
          Reports
        </Link>
        <h1 className="p-3 mt-5 cursor-pointer">Settings</h1>
      </div>
